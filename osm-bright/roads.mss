...
#bridge[render='1_outline'][zoom>=11][zoom<=20]{
  ...
  [zoom=19] {
    [stylegroup='motorway'] { line-width: @rdz19_maj + 5; }
    [stylegroup='mainroad'] { line-width: @rdz19_med + 5; }
    [stylegroup='minorroad']{ line-width: @rdz19_min + 4.5; }
    [stylegroup='service']  { line-width: @rdz19_min / 3 + 4.5; }
    [stylegroup='noauto']   { line-width: @rdz19_min / 4 + 7; }
    [stylegroup='railway']  { line-width: 5 + 7; }
  }
  [zoom>=20] {
    [stylegroup='motorway'] { line-width: @rdz20_maj + 6; }
    [stylegroup='mainroad'] { line-width: @rdz20_med + 6; }
...
#bridge[render='3_inline'][zoom>=11][zoom<=20]{
  ...
  [zoom=13] {
    ...
    [stylegroup='noauto']   { line-width: @rdz13_min / 3; line-dasharray: 1,1; }
  ...
  [zoom=14] {
    ...
    [stylegroup='noauto']   { line-width: @rdz14_min / 3; line-dasharray: 1,1; }
  ...
  [zoom=15] {
    ...
    [stylegroup='noauto']   { line-width: @rdz15_min / 3; line-dasharray: 1,1; }
  ...
  [zoom=16] {
    ...
    [stylegroup='noauto']   { line-width: @rdz16_min / 3; line-dasharray: 2,1; }
  ...
  [zoom=17] {
    ...
    [stylegroup='noauto']   { line-width: @rdz17_min / 3; line-dasharray: 2,2; }
  ...
  [zoom=18] {
    ...
    [stylegroup='noauto']   { line-width: @rdz18_min / 3; line-dasharray: 3,3; }
  ...
  [zoom=19] {
    ...
    [stylegroup='noauto']   { line-width: @rdz19_min / 3; line-dasharray: 4,4; }
  ...
  [zoom>=20] {
    ...
    [stylegroup='noauto']   { line-width: @rdz20_min / 3; line-dasharray: 5,5; }
    [stylegroup='railway']  { line-width:12; }
  }
}
...
#turning_circle_fill {
  ...
  [zoom=19] { marker-width:@rdz19_min * 1.1; }
  [zoom>=20] { marker-width:@rdz20_min * 1.1; }
}
